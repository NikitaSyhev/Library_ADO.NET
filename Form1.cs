...
namespace Biblioteka
{
    public partial class Form1 : Form
    {
        ...
        private void FillBooks(string autor_id="")
        {
            ...
            (dgBooks.Columns["autor_name"] as DataGridViewComboBoxColumn).DataSource = dtAutor;
            (dgBooks.Columns["autor_name"] as DataGridViewComboBoxColumn).DataPropertyName = "id_autor";
            (dgBooks.Columns["autor_name"] as DataGridViewComboBoxColumn).ValueMember = "id";
            (dgBooks.Columns["autor_name"] as DataGridViewComboBoxColumn).DisplayMember = "Name";
